            ...
            builder.Register(c => new MapperConfiguration(cfg =>
                                                          {
                                                              ...
                                                              cfg.CreateMap<User, SurveyAuthorDto>().ReverseMap();
                                                              ...
                                                              cfg.CreateMap<SurveyLookup, SurveyLookupDto>().ReverseMap();
                                                              ...
                                                              cfg.CreateMap<TemplateLookup, TemplateLookupDto>().ReverseMap();
